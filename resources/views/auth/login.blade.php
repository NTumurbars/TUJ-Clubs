<x-layout>
    <h1 class="title text-center text-3xl font-bold ">
        TUJ Clubs
    </h1>
    <br />
    <p class="text-center mb-4">We use Google authentication services to authenticate our users</p>
    <p class="text-center mb-8">Use your <strong class="text-pink-300">TU mail</strong> to gain access to the website and
        its features</p>

    <div
        class="mx-auto max-w-sm card my-8 bg-gradient-to-r from-[#04030F] via-[#491111] to-[#8B0000] p-6 rounded-lg shadow-lg">
        @if ($errors->has('email'))
        ...
        <a href="{{ route('login.google') }}" class="inline-block w-full">
            <button type="button" data-twe-ripple-init data-twe-ripple-color="light"
                ...
                <span
                    class="flex items-center [&>svg]:h-8 [&>svg]:w-8 mr-3 transition duration-500 ease-in-out group-hover:scale-110">
